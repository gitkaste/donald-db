...
(defvar erbn-rr-bangs
  (list 
    (lambda ()
      (concat "/me blows " nick "'s cerebellum all over " tgt "... *BANG*"))
    (lambda ()
      (concat "/me blows " nick "'s brains all over " tgt 
	      "... *BANG* ...reloading."))
    (lambda ()
