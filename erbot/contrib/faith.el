;;; faith.el --- helps spread the true faith
;; Time-stamp: <2004-02-20 13:20:03 deego>
...
;;; QUICKSTART INSTALLATION FOR LOST SOULS:
...
;; The false-quotes have been picked out of books whose long-dead authors are
;; not likely to be in a position to object. Current
;; sources:
;; bible
;; koran
...
(defun faith-justify-string (string)
  ...
  (with-temp-buffer
    (insert string)
    (setq fill-column faith-fill-column) ;; automatically buffer-local. hence set here!
    (fill-paragraph 1)
    (buffer-substring (point-min) (point-max)))
  )
...
(unless faith-replacement-strings
  (setq faith-replacement-strings
	'(
	  ...
	  (("religion") ("editing"))
	  (("satan") ("Microsoft" "Windoze" "SCO" "VI"))
	  (("pray" ) ("edit"))
